...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.temp'
        db.add_column(u'results_club', 'temp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.temp'
        db.delete_column(u'results_club', 'temp')
    ...
    models = {
        ...
        u'results.club': {
            ...
            'temp': ('django.db.models.fields.DateTimeField', [], {}),
