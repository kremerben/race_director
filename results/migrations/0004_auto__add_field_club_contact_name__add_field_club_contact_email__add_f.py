...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.contact_name'
        db.add_column(u'results_club', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=120),
                      keep_default=False)

        # Adding field 'Club.contact_email'
        db.add_column(u'results_club', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Club.contact_phone'
        db.add_column(u'results_club', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.contact_name'
        db.delete_column(u'results_club', 'contact_name')

        # Deleting field 'Club.contact_email'
        db.delete_column(u'results_club', 'contact_email')

        # Deleting field 'Club.contact_phone'
        db.delete_column(u'results_club', 'contact_phone')
