...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomResultField.custom_field_value'
        db.delete_column(u'results_customresultfield', 'custom_field_value')

        # Deleting field 'CustomResultField.basemodel_ptr'
        db.delete_column(u'results_customresultfield', u'basemodel_ptr_id')

        # Adding field 'CustomResultField.id'
        db.add_column(u'results_customresultfield', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Adding field 'CustomResultField.custom_result_name'
        db.add_column(u'results_customresultfield', 'custom_result_name',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=120),
                      keep_default=False)

        # Adding field 'CustomResultField.custom_result_value'
        db.add_column(u'results_customresultfield', 'custom_result_value',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=120, blank=True),
                      keep_default=False)

        # Changing field 'Result.place'
        db.alter_column(u'results_result', 'place', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):
        # Adding field 'CustomResultField.custom_field_value'
        db.add_column(u'results_customresultfield', 'custom_field_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'CustomResultField.basemodel_ptr'
        db.add_column(u'results_customresultfield', u'basemodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['results.BaseModel'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'CustomResultField.id'
        db.delete_column(u'results_customresultfield', u'id')

        # Deleting field 'CustomResultField.custom_result_name'
        db.delete_column(u'results_customresultfield', 'custom_result_name')

        # Deleting field 'CustomResultField.custom_result_value'
        db.delete_column(u'results_customresultfield', 'custom_result_value')

        # Changing field 'Result.place'
        db.alter_column(u'results_result', 'place', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'results.customresultfield': {
            'Meta': {'object_name': 'CustomResultField'},
            'custom_result': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'custom_result'", 'to': u"orm['results.Result']"}),
            'custom_result_name': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'custom_result_value': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'results.race': {
        ...
        u'results.result': {
            ...
            'finish_time': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.SmallIntegerField', [], {}),
            ...
            'start_time': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
        },
        u'results.user': {
