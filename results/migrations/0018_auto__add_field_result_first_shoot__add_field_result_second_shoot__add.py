...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.first_shoot'
        db.add_column(u'results_result', 'first_shoot',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'Result.second_shoot'
        db.add_column(u'results_result', 'second_shoot',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'Result.third_shoot'
        db.add_column(u'results_result', 'third_shoot',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'Result.fourth_shoot'
        db.add_column(u'results_result', 'fourth_shoot',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.first_shoot'
        db.delete_column(u'results_result', 'first_shoot')

        # Deleting field 'Result.second_shoot'
        db.delete_column(u'results_result', 'second_shoot')

        # Deleting field 'Result.third_shoot'
        db.delete_column(u'results_result', 'third_shoot')

        # Deleting field 'Result.fourth_shoot'
        db.delete_column(u'results_result', 'fourth_shoot')
    ...
    models = {
        ...
        u'results.result': {
            ...
            'first_shoot': ('django.db.models.fields.SmallIntegerField', [], {'blank': 'True'}),
            'fourth_shoot': ('django.db.models.fields.SmallIntegerField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'second_shoot': ('django.db.models.fields.SmallIntegerField', [], {'blank': 'True'}),
            'start_time': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'third_shoot': ('django.db.models.fields.SmallIntegerField', [], {'blank': 'True'})
        },
        u'results.user': {
