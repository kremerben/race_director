...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Biathlete'
        db.create_table(u'results_biathlete', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'results', ['Biathlete'])
        ...
        # Adding field 'User.club'
        db.add_column(u'results_user', 'club',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='home_club', null=True, to=orm['results.Club']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Biathlete'
        db.delete_table(u'results_biathlete')
        ...
        # Deleting field 'User.club'
        db.delete_column(u'results_user', 'club_id')
    ...
    models = {
        ...
        u'results.result': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': "'9:00'"})
        },
        u'results.user': {
