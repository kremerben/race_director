...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'results_result', 'finish_time', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'Result.start_time'
        db.alter_column(u'results_result', 'start_time', self.gf('django.db.models.fields.CharField')(max_length=120))
