...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Racer.user'
        db.alter_column(u'results_racer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['results.User'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Racer.user'
        db.alter_column(u'results_racer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['results.User'], unique=True))
