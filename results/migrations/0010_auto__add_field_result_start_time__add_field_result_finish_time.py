...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.start_time'
        db.add_column(u'results_result', 'start_time',
                      self.gf('django.db.models.fields.CharField')(default='9:00', max_length=120),
                      keep_default=False)

        # Adding field 'Result.finish_time'
        db.add_column(u'results_result', 'finish_time',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.start_time'
        db.delete_column(u'results_result', 'start_time')

        # Deleting field 'Result.finish_time'
        db.delete_column(u'results_result', 'finish_time')
    ...
    models = {
        ...
        u'results.result': {
            ...
            'start_time': ('django.db.models.fields.CharField', [], {'default': "'9:00'", 'max_length': '120'})
        },
        u'results.user': {
